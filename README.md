...
در این بخش می‌توان با انتخاب دستی یا به صورت شیپ فایل محدوده مورد نظر خود را انتخاب کنیم. برای انتخاب دستی در بخش پایینی صفحه سایت GEE با کلیک بر روی منطقه و یک چند ضلعی حول محدوده مطالعاتی ایجاد می‌کنیم. 
