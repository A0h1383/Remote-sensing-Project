...
کدهای قابل‌خواندن مستقیماً از متن تصاویر بازسازی شده‌اند. در `04_esfahan_zero_crossing.js` بخش تعریف متغیر `fat` در تصویر اصلی خارج از محدوده نمایش بوده؛ بنابراین همان بخش با توضیح مشخص شده و باید در صورت نیاز با مقدار اصلی ادیتور جایگزین شود. در پروژه DEM، تعریف دو DEM میانی از روی نام و خروجی‌های قابل مشاهده تکمیل شده است.
