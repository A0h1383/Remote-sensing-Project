...
## فراخوانی، نمایش و ترکیب باندهای تصاویر ماهواره‌ای
<div align='justify'>
در قسمت Earth Engine Data Catalog تصویر ماهواره لندست 8 را دریافت می‌کنیم و فیلتر مکانی بر روی منطقه مطالعاتی، همچنین فیلتر زمانی مناسب با استفاده از filterDate ایجاد می‌کنیم.
</div>
